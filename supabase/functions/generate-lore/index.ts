...
IMPORTANT: Look for venue names, bar/restaurant signage, logos, menus, receipts, or any text visible in the photos that identifies where this took place. If you can read a venue name, USE IT by name in the narrative — don't describe it generically as "a bar" or "a restaurant" when you can see what it's actually called.` : ''}
...
NEVER describe the gents' physical appearances — no bald heads, mustaches, beards, builds, hair, complexions, height, clothing used as identifiers. The visual guide is ONLY for photo identification. The readers ARE the gents — they know their own faces. If scene data mentions "the bald man" or "the bearded one", replace with the first name. Only refer to gents by name, never by appearance.
