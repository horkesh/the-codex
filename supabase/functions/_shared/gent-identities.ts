...
export const GENT_APPEARANCES: Record<string, string> = {
  haris: 'A lean, angular-faced man in his 40s. He is completely bald, featuring a smooth, shaved head. The most distinct feature is a prominent, substantial handlebar mustache with tightly waxed, upward-curled tips. This is framed by a very short, neatly trimmed close-cropped beard and goatee along the jaw and chin. Medium complexion.',
  vedad: 'A tall, well-built man in his mid-30s. He has a thick head of dark brown hair, featuring a clean, short taper on the sides and back, with the longer top styled upward and back into a textured quiff. The most distinct feature is a prominent, dense full dark brown beard with substantial natural fullness. This is framed by a neatly trimmed matching mustache and meticulously defined, sharp lines along the cheeks and neck. Light complexion.',
...
- Haris (alias "Lorekeeper"): bald, handlebar mustache with waxed upward-curled tips, close-cropped beard
- Vedad (alias "Beard & Bass"): dark brown textured quiff, full dense dark brown beard, light complexion
