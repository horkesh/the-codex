...
- Almedin ("Keys & Cocktails"): SALT-AND-PEPPER GREY HAIR + CLEAN-SHAVEN (NEVER has a beard). The oldest-looking — greying hair distinguishes him from the others who have darker brown hair. High fade, square jaw, intense deep-set dark eyes. Sometimes wears rectangular glasses. KEY RULE: if someone wears glasses but is CLEAN-SHAVEN = Almedin. If someone wears glasses but HAS A BEARD = Mirza.
- Mirza ("Retired Operative"): TALLEST + BROADEST + SHORT BEARD + ROUND FACE. ALWAYS has facial hair (short beard/stubble — never clean-shaven). The biggest person in the group — slightly taller and noticeably broader than Vedad. Fair complexion. Sometimes wears glasses. Short cropped hair that can appear bald in low light. A retired member — no longer active.
